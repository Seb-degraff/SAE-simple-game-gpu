...
@REM clang++ -o game.exe game.cpp engine.cpp -g -DSOKOL_D3D11 -std=c++20 -Wno-c99-designator -Wno-reorder-init-list
echo "Use build_opengl instead, which is setup for hot reload."